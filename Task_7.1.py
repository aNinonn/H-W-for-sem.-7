...
set1 = {"а", "у", "о", "и", "э", "ы", "я", "ю", "е", "ё"}
result_list = []

def rythm(str1: str):
     phraze = [list(str1.split(" ")[i]) for i in range (len(str1.split(" ")))]
     for line in range(len(phraze)):
         count = 0
         for word in range(len(phraze[line])):
             if phraze[line][word] in set1:
                 count +=1
         result_list.append(count)
     return True if len(set(result_list)) == 1 else False
